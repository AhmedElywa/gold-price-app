...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${dict.terms.title} | ${dict.app.brand}`,
  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <section className="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">{dict.terms.title}</h1>
        <p className="text-gray-700 mb-4">{dict.terms.content}</p>
