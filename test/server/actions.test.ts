...
const mockSendNotification = mock(() => Promise.resolve({ statusCode: 201, body: 'Success', headers: {} }));
...
describe('Notification Actions', () => {
  ...
  beforeEach(async () => {
    ...
    mockSendNotification.mockImplementation(() => Promise.resolve({ statusCode: 201, body: 'Success', headers: {} }));
